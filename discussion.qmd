...
Check out our [online discussion forum](https://github.com/ai-r-meetup/AIxR/discussions) where you can contribute to existing threads or bring up new topics. 
...
```{r, echo = F, warning=F, message=F, out.width="100%", eval = F}
library(tidyverse)
t <- tempfile()
